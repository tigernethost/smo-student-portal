...
class QuizSession extends Model {
    ...
    // Accessors for Filament display
    public function getScoreAttribute() { return $this->correct; }
    public function getTotalQuestionsAttribute() { return $this->attributes['total_questions'] ?? 0; }
}
